	...
	return (
		...
		>
			...
			<g id="Capa_1-2">
				...
				>
					<stop offset=".11" style={{ stopColor: '#157198', stopOpacity: 0 }} />
					<stop
						offset=".35"
					...
					/>
					<stop offset="1" style={{ stopColor: '#157198', stopOpacity: 0.9 }} />
				</linearGradient>
				<path
					style={{
						fillRule: 'evenodd',
				...
				>
					<stop offset=".26" style={{ stopColor: '#157198', stopOpacity: 0 }} />
					<stop
						offset=".75"
						style={{ stopColor: '#157198', stopOpacity: 0.63 }}
					/>
