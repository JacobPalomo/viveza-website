...
const Fact: FC<FactProps> = ({ ornaments, content }) => {
	...
	return (
		<Section className='!h-screen'>
			...
			<motion.div
				ref={containerRef}
				className='scroll-text-reveal relative flex w-full flex-col items-center justify-center'
			...
			>
				...
				{/* Cinta metrica */}
				<div className='absolute top-[105%] right-10'>
					{ornaments && (
						<Image
