		...
		<>
			...
			>
				...
				<polygon
					fill={
						color === 'normal'
							? 'url(#gradient-normal-1)'
							: 'url(#gradient-custom-color-1)'
					}
					fillRule='evenodd'
				...
				<polygon
					fill={
						color === 'normal'
							? 'url(#gradient-normal-2)'
							: 'url(#gradient-custom-color-2)'
					}
					fillRule='evenodd'
